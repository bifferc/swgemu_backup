...
function GeonosianLabScreenPlay:spawnMobiles()
	...
	spawnMobile("yavin4", "yivvits", 1,-107.7,-18,-33.8,176,1627790)--Mandalorian Armor Vendor 77777
	...
	spawnMobile("yavin4", "mlo_lemo", 1, -127.2, -34, -189.0, -93, 1627815)--Bounty Hunter Vendor 99999
