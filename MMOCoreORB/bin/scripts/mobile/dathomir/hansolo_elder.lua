hansolo_elder = Creature:new {
	customName = "Han Solo (Elder)",
	faction = "",
	level = 227,
	chanceHit = 19.75,
	damageMin = 1270,
	...
	attacks = merge(commandomaster,forcepowermaster)
}

CreatureTemplates:addCreatureTemplate(hansolo_elder, "hansolo_elder")
